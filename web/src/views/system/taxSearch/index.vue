<template>
<d2-container>
  <!-- <div id='showorders3' style='width: 500px; height: 500px'></div> -->
  <!-- <div id="node_search"  style='width: 500px; height: 500px'>
    <el-input v-model="input" placeholder="请输入内容" size="large">
      <el-button slot="append" icon="el-icon-search" @click="onSubmit" ></el-button>
    </el-input>
    <div id="chart" class="chart" style='width: 500px; height: 450px'></div>
  </div> -->
  <div slot="header">
        <crud-search
          ref="search"
  ...
  <div id="chart" class="chart" style='width: 900px; height: 500px'></div>
  <!-- <div id='showorders1' style='width: 500px; height: 500px'></div> -->
</d2-container>
</template>
